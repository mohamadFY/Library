...
public class PatronController {
    ...
    public ResponseEntity<List<Patron>> getAllPatron(){
        return new ResponseEntity<List<Patron>>(patronService.getAllPatron(), HttpStatus.OK);
    }
    ...
    public ResponseEntity<? extends Object> addPatron(@RequestBody @Valid Patron patron){
        try {
            ...
            return new ResponseEntity<String>("duplicate Phone number",HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }

    @PutMapping("/{id}")
    public ResponseEntity<Patron> update(@PathVariable long id,@RequestBody @Valid Patron patron){
    ...
    public ResponseEntity<? extends Object> deleteById(@PathVariable long id) throws Exception {
        try {
            ...
            return new ResponseEntity<String>("CAN'T DELETE PATRON",HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
